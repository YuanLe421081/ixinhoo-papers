 ...
 * @author cici
 */
public class DocumentDetailDto implements java.io.Serializable{
    ...
    List<DocumentViewDto> viewList;//预览图

    public List<DocumentViewDto> getViewList() {
        return viewList;
    }

    public void setViewList(List<DocumentViewDto> viewList) {
